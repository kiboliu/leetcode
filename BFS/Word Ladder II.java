...
class Solution {
	public List<List<String>> findLadders(String start, String end, List<String> dictionary) {
	...
	boolean helper(Set<String> dict, Set<String> set1, Set<String> set2, Map<String, List<String>> map, boolean flip) {
		...
		//as we only need the shortest paths, use a boolean value help early termination.
		boolean done = false;
